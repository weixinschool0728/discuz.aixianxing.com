...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<div id="ft" class="wp cl">
		...
		<div id="frt">
			...
			<p class="xs0">&copy; 2001-2015 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a> Templated By <a href="http://addon.discuz.com/?@2367.developer" target="_blank">【未来科技 www.wekei.cn】设计</a> </p>
		</div>
		<!--{eval updatesession();}-->
